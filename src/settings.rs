...
impl Default for AppSettings {
    fn default() -> Self {
        Self {
            ...
            actions_shortcut: String::from("cmd+k"),
...
impl From<&AppSettings> for SettingsForm {
    fn from(settings: &AppSettings) -> Self {
        Self {
            ...
            actions_shortcut: settings.actions_shortcut.clone(),
...
impl SettingsForm {
    pub fn parse(&self) -> Result<AppSettings, String> {
        let settings = AppSettings {
            ...
            actions_shortcut: validate_shortcut(&self.actions_shortcut, "Actions shortcut")?,
